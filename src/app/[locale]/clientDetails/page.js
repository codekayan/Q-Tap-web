...
const options = [
  {
    label: "Takeaway",
    icon: <span className="icon-takeaway" style={{ fontSize: "45px" }}></span>,
    value: "take_away",
  },
  {
    label: "Dine In",
    icon: <span className="icon-table" style={{ fontSize: "45px" }}></span>,
    value: "dine_in",
  },
  {
    label: "Delivery",
    icon: <span className="icon-scooter" style={{ fontSize: "45px" }}></span>,
    value: "delivery",
  },
];
const page = () => {
  ...
  useEffect(() => {
    ...
    const branch = shop?.brunchs?.find(
    ...
    if (!tableId) {
      ...
      const dineIn = branch?.serving_ways?.find(
        (item) => item.name === "dine_in"
      );
      console.log(branch);
      if (dineIn) {
  ...
  const getTransformStyle = (optionValue) => {
    ...
    if (optionValue === "dine_in") {
      return selectedOption === "take_away"
        ? translateMap.take_away
        : translateMap.delivery;
    }
      ...
      case "dine_in":
        return (
          <span
            ...
            style={{ fontSize: "70px", color: "#aaaaaa2c" }}
          ></span>
        );
                  ...
                  branchServigWay?.some(
                    ...
                    <Box
                      ...
                      sx={{
                        ...
                        color:
                          selectedOption === option.value ? "#fff" : "#aaa",
                        display: "flex",
      ...
      >
        ...
        {selectedOption && (
          <Box sx={{ padding: "0px 20px" }}>
            <Typography
              variant="body2"
              sx={{ fontSize: "11px", marginBottom: "3px", color: "white" }}
            >
              {t("name")}
            </Typography>
            <TextField
            ...
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <span style={{ fontSize: "20px", color: "#797993" }}>
                      %
                    </span>
                  </InputAdornment>
                ),
      ...
      >
        <Box sx={{ width: "90%" }}>
          <Typography variant="h6" sx={{ fontSize: "12px", color: "#AAAAAA" }}>
            {t("subTotal")}:{" "}
            <span style={{ color: "white" }}>{subTotal} EGP</span>
          </Typography>
          ...
          <Typography variant="h6" sx={{ fontSize: "12px", color: "#AAAAAA" }}>
            {t("disCount")}:{" "}
            <span style={{ color: "white" }}>{discount} EGP</span>
          </Typography>

          <Divider
            sx={{ margin: "3px 30px 3px 0px", backgroundColor: "#AAAAAA" }}
          />

          <Typography
            variant="h6"
            sx={{ fontSize: "11px", fontWeight: "bold", color: "#AAAAAA" }}
          >
            {t("totalPrice")}
          </Typography>
          <Typography
          ...
          >
            {totalPrice}
            <span
              style={{ fontSize: "10px", fontWeight: "400", color: "#AAAAAA" }}
            >
              EGP
            </span>
          </Typography>
        ...
        <Box sx={{ width: "100%" }}>
          ...
          >
            {t("placeOrder")}
            <DoneOutlinedIcon sx={{ fontSize: "20px", ml: 1 }} />
          </Button>
          {/* </Link> */}
        </Box>
      </Box>
